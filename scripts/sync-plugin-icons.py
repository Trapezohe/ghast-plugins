...
LOCAL_ICONS = {
    ...
    "morningstar": "assets/icon.svg",
    "myregistry-com": "assets/icon.svg",
    "neon-postgres": "assets/icon.svg",
    "nvidia": "assets/icon.png",
    "particl-market-research": "assets/icon.svg",
    "picsart": "assets/icon.png",
    "policynote": "assets/icon.svg",
    "pylon": "assets/icon.svg",
    "ranked-ai": "assets/icon.svg",
    "remotion": "assets/icon.png",
    "render": "assets/icon.svg",
    "replayio": "assets/icon.svg",
    "responsive": "assets/icon.svg",
    "s-p": "assets/icon.svg",
    "setu-bharat-connect-billpay": "assets/icon.svg",
    ...
    "third-bridge": "assets/icon.svg",
    "vantage": "assets/icon.svg",
    "vercel": "assets/icon.svg",
    "waldo": "assets/icon.svg",
    "wix": "assets/icon.svg",
    "zoominfo": "assets/icon.svg",
