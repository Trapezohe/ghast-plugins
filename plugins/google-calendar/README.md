# Google Calendar for Ghast

## 简介 / Overview

通过 Google 官方 Workspace MCP 服务查找日程、检查空闲时间与管理会议。

Find events, check availability and manage meetings through Google’s official Workspace MCP service.
...
- MCP: `https://calendarmcp.googleapis.com/mcp/v1`
...
Brand logo source: https://www.gstatic.com/images/branding/productlogos/calendar_2026/v2/web/192px.svg
...
```text
https://www.googleapis.com/auth/calendar.calendarlist.readonly https://www.googleapis.com/auth/calendar.events.readonly https://www.googleapis.com/auth/calendar.events.freebusy
```
