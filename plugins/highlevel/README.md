...
The CC0-1.0 license is copied from HighLevel's pinned official API documentation repository. Ghast connects directly to HighLevel's official hosted MCP endpoint and adds only adapter metadata, a safety workflow, and the provider brand logo; no HighLevel server code, private connector mapping, or marketplace artwork is packaged.
...
- Brand logo source: https://storage.googleapis.com/msgsndr/knES3eSWYIsc5YSZ3YLl/media/62b48689c85eccb36ca941fc.png. Brand names and logos belong to HighLevel LLC. 品牌名称与标识归对应服务商所有。
