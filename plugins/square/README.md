...
通过 Square 查看门店、商品、客户、订单和支付，协助零售运营。

Explore retail locations, catalogs, customers, orders and payments through Square.

## 连接 / Connection

在浏览器连接 Square，选择任务所需的最小权限。托管服务访问生产环境，不是沙箱。
...
- MCP endpoint: `https://mcp.squareup.com/mcp`
- [Provider documentation / 官方文档](https://developer.squareup.com/docs/mcp)
...
Brand logo source: https://cdn.simpleicons.org/square/006AFF
