# Google Sheets for Ghast

## 简介 / Overview

通过 Google 官方 Workspace MCP 服务读取表格并更新数据、公式与结构。

Read spreadsheets and update values, formulas and structure through Google’s official Workspace MCP service.
...
- MCP: `https://sheetsmcp.googleapis.com/mcp/v1`
...
Brand logo source: https://www.gstatic.com/images/branding/productlogos/sheets_2026q3/v1/web/192px.svg
