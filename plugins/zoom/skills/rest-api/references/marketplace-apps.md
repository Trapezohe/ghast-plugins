...
| Claude MCP Connector / MCP API app | `usage: "USER_OPERATION"`, `products: []` or omitted, no Team Chat subscription, scopes for AI Companion search, Canvas import/export, meeting assets/search, recordings, or Team Chat MCP workflows | [Zoom MCP](../../zoom-mcp/SKILL.md) and [REST API](../SKILL.md) |
