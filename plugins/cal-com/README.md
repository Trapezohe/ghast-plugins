...
使用 Cal.com 查询空闲时间、管理预约类型、整理日程和会议预约。

Check availability, manage event types and organize bookings and schedules with Cal.com.

## 连接 / Connection

通过浏览器 OAuth 连接 Cal.com，连接器使用你的账号权限。

Connect Cal.com through browser OAuth. The connector acts with your account permissions.

- MCP endpoint: `https://mcp.cal.com/mcp`
- [Provider documentation / 官方文档](https://cal.com/docs/mcp-server)
...
Brand logo source: https://cdn.simpleicons.org/caldotcom/292929
