# Google Drive for Ghast

## 简介 / Overview

通过 Google 官方 Workspace MCP 服务检索、阅读与整理云端硬盘文件。

Search, read and organize Drive files through Google’s official Workspace MCP service.
...
- MCP: `https://drivemcp.googleapis.com/mcp/v1`
...
Brand logo source: https://www.gstatic.com/images/branding/productlogos/drive_2026/v2/web/192px.svg
