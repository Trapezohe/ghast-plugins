...
metadata:
  version: "2.3.1"
  compatibility: "Requires the Ghast Catalyst plugin or another MCP-capable AI host such as Claude Desktop, VS Code with GitHub Copilot, or Cursor."
---
...
2. **⛔ MCP NOT connected — HARD STOP.**
  ...
  > Set `CATALYST_MCP_REGION` in Ghast or add your DC-specific URL to another AI client, authorize once via browser, done. No console needed. Pick your DC's URL from the table in `references/zoho-mcp.md` (setup) — or `references/dc-switching.md` to change DCs later.
   >
...
| `references/dc-switching.md` | Switching data centers on Ghast or another MCP-capable client |
