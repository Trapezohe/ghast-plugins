# CoinMarketCap for Ghast

## 简介 / Overview

研究加密货币价格、排名、市场指标与新闻。

Research cryptocurrency prices, rankings, market metrics and news.

## 连接 / Connection

在 CoinMarketCap 账号中创建 API Token，填入 Ghast 连接凭据输入框；由 Ghast 注入 X-CMC-MCP-API-KEY 请求头。不要在聊天中发送凭据，使用受服务配额限制。
...
- MCP: `https://mcp.coinmarketcap.com/mcp`
- [官方文档 / Provider documentation](https://coinmarketcap.com/api/mcp/)
