...
metadata:
  ...
  pathPatterns: '["next.config.*","app/**","src/app/**","apps/*/app/**","apps/*/src/app/**"]'
  importPatterns: '["next/cache"]'
  bashPatterns: '["\\bnext\\s+(dev|build)\\b"]'
  promptSignals: '{"allOf":[["cache","component"],["cache","directive"],["partial","prerender"]],"anyOf":["revalidateTag","stale","revalidate","cache profile"],"minScore":6,"noneOf":[],"phrases":["use cache","cache components","partial prerendering","PPR","cacheLife","cacheTag","updateTag","unstable_cache"]}'
  validate: '[{"message":"unstable_cache is deprecated in Next.js 16 — use the \"use cache\" directive with cacheTag() and cacheLife() instead","pattern":"unstable_cache\\s*\\(","severity":"recommended","upgradeToSkill":"next-cache-components","upgradeWhy":"Guides migration from unstable_cache to use cache directive with cacheTag and cacheLife."},{"message":"Singular cacheHandler is deprecated in Next.js 16 — use cacheHandlers (plural) with per-type handlers","pattern":"\\bcacheHandler\\s*:","severity":"recommended"},{"message":"Single-arg revalidateTag(tag) is deprecated in Next.js 16 — pass a cacheLife profile: revalidateTag(tag, \"max\")","pattern":"revalidateTag\\(\\s*[''\"][^''\"]+[''\"]\\s*\\)","severity":"recommended"}]'
  retrieval: '{"aliases":["cache components","partial prerendering","PPR","use cache"],"entities":["use cache","cacheLife","cacheTag","updateTag","revalidateTag","PPR"],"intents":["enable partial prerendering in Next.js","cache async data with use cache directive","invalidate cache with cacheTag","migrate from unstable_cache"]}'
  chainTo: '[{"message":"Cache component detected — loading Next.js best practices for RSC boundaries and data patterns alongside caching.","pattern":"use cache","skipIfFileContains":"next-best-practices","targetSkill":"nextjs"}]'
---
