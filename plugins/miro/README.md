...
读取团队白板，整理创意、制作图表并协作编辑 Miro 看板。

Read team whiteboards and develop diagrams, ideas and collaborative board content with Miro.

## 连接 / Connection

在浏览器连接 Miro 并选择团队；企业账号可能需要管理员启用 MCP。

Connect Miro in the browser and choose a team. Enterprise administrators may need to enable MCP access.

- MCP endpoint: `https://mcp.miro.com/`
- [Provider documentation / 官方文档](https://developers.miro.com/docs/miro-mcp-server-frequently-asked-questions)
...
Brand logo source: https://cdn.simpleicons.org/miro/050038
