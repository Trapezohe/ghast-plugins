# Google Chat for Ghast

## 简介 / Overview

通过 Google 官方 Workspace MCP 服务检索会话、阅读消息与沟通协作。

Search conversations, read messages and communicate through Google’s official Workspace MCP service.
...
- MCP: `https://chatmcp.googleapis.com/mcp/v1`
...
Brand logo source: https://www.gstatic.com/images/branding/productlogos/chat_2026/v2/web/192px.svg
